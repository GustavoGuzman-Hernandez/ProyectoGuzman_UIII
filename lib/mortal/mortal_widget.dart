...
class MortalWidget extends StatefulWidget {
  const MortalWidget({Key key}) : super(key: key);

  @override
  _MortalWidgetState createState() => _MortalWidgetState();
}

class _MortalWidgetState extends State<MortalWidget> {
                    ...
                    Stack(
                      children: [
                        Container(
                          ...
                          child: Image.network(
                            'https://raw.githubusercontent.com/GustavoGuzman-Hernandez/imagenesGitHub/main/Mortal_Kombat-245960455-large.jpg',
