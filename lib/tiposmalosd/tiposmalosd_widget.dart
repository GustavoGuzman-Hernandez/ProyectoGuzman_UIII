...
class TiposmalosdWidget extends StatefulWidget {
  const TiposmalosdWidget({Key key}) : super(key: key);

  @override
  _TiposmalosdWidgetState createState() => _TiposmalosdWidgetState();
}

class _TiposmalosdWidgetState extends State<TiposmalosdWidget> {
