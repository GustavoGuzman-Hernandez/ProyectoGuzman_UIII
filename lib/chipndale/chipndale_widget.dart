...
class ChipndaleWidget extends StatefulWidget {
  const ChipndaleWidget({Key key}) : super(key: key);

  @override
  _ChipndaleWidgetState createState() => _ChipndaleWidgetState();
}

class _ChipndaleWidgetState extends State<ChipndaleWidget> {
