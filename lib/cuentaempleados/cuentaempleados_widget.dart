...
class CuentaempleadosWidget extends StatefulWidget {
  const CuentaempleadosWidget({Key key}) : super(key: key);

  @override
  _CuentaempleadosWidgetState createState() => _CuentaempleadosWidgetState();
}

class _CuentaempleadosWidgetState extends State<CuentaempleadosWidget> {
              ...
              children: [
                SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(24, 20, 0, 16),
                        child: Row(
                          mainAxisSize: MainAxisSize.max,
